    ...
    <section className="section-container">
      ...
      <div className="flex flex-col gap-6">
        {resumeData.workExperience.map((exp, index) => (
          <div key={index} className="flex flex-col gap-3 relative pl-4 border-l-2 border-[#d2d2d7] hover:border-primary transition-colors">
            <div className="absolute -left-[9px] top-1.5 w-4 h-4 rounded-full bg-white border-2 border-primary"></div>
            <div className="flex flex-wrap items-baseline gap-2">
              ...
              <span className="text-primary text-sm sm:ml-auto font-medium">{exp.period}</span>
            </div>
